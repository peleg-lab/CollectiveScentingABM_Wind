...
def config_options():
    ...
    parser.add_argument("--ww", type=int, default=30)
    parser.add_argument("--wwx", type=float, default=0)
    parser.add_argument("--wwy", type=float, default=-0.1)
...
def directory(config):
    ...
    params_name = f"Q{Q}_W{W}_D{D}_T{T:0.5f}_wb{wb}_decay{decay}_ww{ww}_seed{seed}"
